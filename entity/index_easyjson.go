...
func easyjsonE2a549a6DecodeGithubComSoulgardenLogfowdEntity3(in *jlexer.Lexer, out *DynamicTemplates) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE2a549a6EncodeGithubComSoulgardenLogfowdEntity3(out *jwriter.Writer, in DynamicTemplates) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
// MarshalJSON supports json.Marshaler interface
func (v DynamicTemplates) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE2a549a6EncodeGithubComSoulgardenLogfowdEntity3(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v DynamicTemplates) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonE2a549a6EncodeGithubComSoulgardenLogfowdEntity3(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *DynamicTemplates) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE2a549a6DecodeGithubComSoulgardenLogfowdEntity3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *DynamicTemplates) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE2a549a6DecodeGithubComSoulgardenLogfowdEntity3(l, v)
}
